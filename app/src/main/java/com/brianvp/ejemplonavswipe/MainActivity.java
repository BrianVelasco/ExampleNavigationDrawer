package com.brianvp.ejemplonavswipe;
...
import com.brianvp.ejemplonavswipe.Fragments.AmarilloFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Utilidades.validarPantalla){
            getSupportFragmentManager().beginTransaction().replace(R.id.contenedor,new FormularioFragment()).commit();
